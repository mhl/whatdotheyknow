...
ActiveRecord::Schema.define(:version => 20091027223448) do
  ...
  create_table "censor_rules", :force => true do |t|
    ...
    t.text     "replacement",       :limit => 16777215, :null => false
    t.string   "last_edit_editor",                      :null => false
    t.text     "last_edit_comment", :limit => 16777215, :null => false
  ...
  create_table "exim_log_dones", :force => true do |t|
    t.text     "filename",   :limit => 16777215, :null => false
  ...
  create_table "exim_logs", :force => true do |t|
    ...
    t.text     "line",             :limit => 16777215, :null => false
    t.datetime "created_at",                           :null => false
    t.datetime "updated_at",                           :null => false
  end
  ...
  create_table "incoming_messages", :force => true do |t|
    ...
    t.datetime "created_at",                                 :null => false
    t.datetime "updated_at",                                 :null => false
    t.text     "cached_attachment_text", :limit => 16777215
    t.text     "cached_main_body_text",  :limit => 16777215
    t.integer  "raw_email_id",                               :null => false
  end

  create_table "info_request_events", :force => true do |t|
    t.integer  "info_request_id",                         :null => false
    t.text     "event_type",          :limit => 16777215, :null => false
    t.text     "params_yaml",         :limit => 16777215, :null => false
    t.datetime "created_at",                              :null => false
  ...
  create_table "info_requests", :force => true do |t|
    ...
    t.text     "url_title",                 :limit => 16777215,                        :null => false
  ...
  create_table "post_redirects", :force => true do |t|
    t.text     "token",              :limit => 16777215, :null => false
    t.text     "uri",                :limit => 16777215, :null => false
    t.text     "post_params_yaml",   :limit => 16777215
    t.datetime "created_at",                             :null => false
    t.datetime "updated_at",                             :null => false
    t.text     "email_token",        :limit => 16777215, :null => false
    t.text     "reason_params_yaml", :limit => 16777215
    t.integer  "user_id"
    t.text     "circumstance",       :limit => 16777215, :null => false
  end
  ...
  create_table "public_bodies", :force => true do |t|
    ...
    t.text     "short_name",          :limit => 16777215,                :null => false
    t.text     "request_email",       :limit => 16777215,                :null => false
    t.integer  "version",                                                :null => false
    t.string   "last_edit_editor",                                       :null => false
    t.text     "last_edit_comment",   :limit => 16777215,                :null => false
    t.datetime "created_at",                                             :null => false
    t.datetime "updated_at",                                             :null => false
    t.text     "url_name",            :limit => 16777215,                :null => false
    t.text     "home_page",           :limit => 16777215,                :null => false
    t.text     "notes",               :limit => 16777215,                :null => false
    t.string   "first_letter",                                           :null => false
    t.text     "publication_scheme",  :limit => 16777215,                :null => false
    t.text     "charity_number",      :limit => 16777215,                :null => false
  ...
  create_table "public_body_versions", :force => true do |t|
    ...
    t.text     "short_name",         :limit => 16777215
    t.text     "request_email",      :limit => 16777215
    t.datetime "updated_at"
    t.string   "last_edit_editor"
    t.text     "last_edit_comment",  :limit => 16777215
    t.text     "url_name",           :limit => 16777215
    t.text     "home_page",          :limit => 16777215
  ...
  create_table "users", :force => true do |t|
    ...
    t.text     "ban_text",               :limit => 16777215,                                    :null => false
